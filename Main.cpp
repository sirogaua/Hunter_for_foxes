...
int main()
{
	...
	if (k == 0)
	{
		...
		while (window.isOpen())
		{
			...
			text.setPosition(900, 25);

			std::ostringstream playerScoreString1;
			playerScoreString1 << Kolvo_osndia;
			text.setString("Fox in Main Diagonal: " + playerScoreString1.str());
			...
			text.setString("Fox in Side Diagonal: " + playerScoreString2.str());

			window.draw(text);

			text.setPosition(900, 75);

			std::ostringstream playerScoreString3;
			playerScoreString3 << Kolvo_Radok;
			text.setString("Fox in Row: " + playerScoreString3.str());
			...
			text.setString("Fox in Column: " + playerScoreString4.str());
			...
			text.setString("You should to search " + playerScoreString5.str() + " foxes");

			window.draw(text);

			text.setPosition(900, 250);
...
int Menu(RenderWindow &window)
{
	...
	Music mus;
	mus.openFromFile("music/track1.wav");
	mus.play();
